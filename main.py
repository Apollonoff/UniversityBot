...
if skills_set.issubset(gum_set):
    ...
    print("Какая сфера гуманитарного образования Вам больше нравится?\n"
          ...
          "5. История")
    sector_gum = 0
    while sector_gum < 1 or sector_gum > 4:  # защищаем от ввода некорректных цифр
        try:
            sector_gum = int(input('введите номер сферы: '))
            if sector_gum < 1 or sector_gum > 4:
                print('Введите только доступные варианты. Повторите снова')
        except ValueError:  # ValueError. Исключение, возникающее в случаях, когда в функцию передан аргумент с неподдерживаемым значением
            print(f'{name}, введите только доступные варианты. Повторите снова')
    if sector_gum == 1:
...
if skills_set.issubset(chem_set):  # проверяет, находятся ли предметы абитуры в укрупненном техническом множестве
    print('Поздравляю, Вы выбрали химико-биологическое направление!')
    print("Какая сфера химико-биологического образования Вам больше нравится?\n"
          ...
          "4. Сфера геологии")
    chem_set = 0
    while chem_set < 1 or chem_set > 3:  # защищаем от ввода некорректных цифр
        try:
            chem_set = int(input('введите номер сферы: '))
            if chem_set < 1 or chem_set > 3:
                print('Введите только доступные варианты. Повторите снова')
        except ValueError:  # ValueError. Исключение, возникающее в случаях, когда в функцию передан аргумент с неподдерживаемым значением
            print(f'{name}, введите только доступные варианты. Повторите снова')
    if chem_set == 1:
